...
trainer.grid_search(agent, [0.9, 0.9, 0.1], [7, 7, 1], [5000, 50000, 10000], [0, 1, 0.2], visualize=True, save_visualize="training_5.png")
...
class Trainer():
    ...
    def train(self, agent, q_param, iteration_n, trajectory_n, lmbd=0, visualize=False, smoothing="laplace"):
        rewards = []
